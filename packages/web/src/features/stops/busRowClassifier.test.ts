...
describe('classifyBusRows', () => {
  ...
  it('returns rows sorted by scheduled time ascending', () => {
    const scheduledVisits: ScheduledStopVisit[] = [
      { tripId: 'A', routeId: '1', stopId: 'X', stopSequence: 1, scheduledTime: 1779470000, headsign: 'X' },
      { tripId: 'B', routeId: '1', stopId: 'X', stopSequence: 1, scheduledTime: 1779468000, headsign: 'X' },
      { tripId: 'C', routeId: '1', stopId: 'X', stopSequence: 1, scheduledTime: 1779469000, headsign: 'X' },
    ];
    const rows = classifyBusRows({
      scheduledVisits,
      tripUpdates: [],
